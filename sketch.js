...
function setup()
{
  ...
  //level1
  blocks1=new Block(930,140,30,30);
  blocks2=new Block(900,140,30,30);
  blocks3=new Block(870,140,30,30);

  blocks4=new Block(915,100,30,30);
  blocks5=new Block(885,100,30,30);

  blocks6=new Block(900,50,30,30);
...
function draw()
{
  ...
  textSize(24);
  text("Drag hexagonal stone and release to launch towards blocks", 250, 20);
